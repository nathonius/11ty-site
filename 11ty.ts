...
type EventNamesDeprecated = LiteralUnion<
  "beforeBuild" | "beforeWatch" | "afterBuild",
  string
>;

type EventNames = LiteralUnion<
  "eleventy.before" | "eleventy.after" | "eleventy.beforeWatch",
  string
>;
 ...
 */
export type EleventyPlugin = (eleventy: EleventyConfig, options?: any) => any;
...
interface Filters {
  ...
  addLiquidFilter(
    filterName: string,
    filter: (this: EleventyScope, ...args: any[]) => string
  ): void;
  /**
   * Handlebars Filter
   *
  ...
  addNunjucksAsyncFilter(
    filterName: string,
    filter: (this: EleventyScope, callback: AsyncFilter) => void
  ): void;
  /**
   * Nunjucks Async Filter
   *
  ...
  addNunjucksAsyncFilter(
    filterName: string,
    filter: (this: EleventyScope, arg: any, callback: AsyncFilter) => void
  ): void;
  /**
   * Nunjucks Async Filter
   *
...
interface ShortCodes {
  ...
  addPairedHandlebarsShortcode(
    shortcodeName: string,
    filter: (this: EleventyScope, content: string, ...args: any[]) => string
  ): void;
}
...
export interface EleventyConfig extends Filters, ShortCodes, PluginExtend {
   ...
   */
  setTemplateFormats(
    formats: readonly TemplateEngines[] | Join<TemplateEngines[], ",">
  ): void;
  /**
  ...
  addFilter<T = string>(
    filterName: string,
    filter: (this: EleventyScope, ...args: any[]) => T
  ): void;
  /**
   ...
   */
  getFilter<T = string>(filterName: string): (...args: any[]) => T;
  /**
  ...
  amendLibrary(name: TemplateEngines, handler: (lib: any) => void): void;
  addPreprocessor(
    name: string,
    formats: string,
...
export const defineConfig = (
  eleventy: (eleventyConfig: EleventyConfig) => ReturnConfig | undefined
) => eleventy;
...
export type LayoutData = ViewData & {
  [key: string]: any;
};
